 ...
 */
@ConvertAsProperties(
        dtd = "-//com.factory.sure.view.chart//G2IHistoryLineChart//EN",
        autostore = false)
@TopComponent.Description(
        preferredID = "G2IHistoryLineChartTopComponent",
        //iconBase="SET/PATH/TO/ICON/HERE", 
        persistenceType = TopComponent.PERSISTENCE_NEVER)
@TopComponent.Registration(mode = "output", openAtStartup = false)
@ActionID(category = "Window", id = "com.factory.sure.view.chart.G2IHistoryLineChartTopComponent")
@ActionReference(path = "Menu/Window" /*, position = 333 */)
@TopComponent.OpenActionRegistration(
        displayName = "#CTL_G2IHistoryLineChartAction",
        preferredID = "G2IHistoryLineChartTopComponent")
@Messages({
    "CTL_G2IHistoryLineChartAction=G2IHistoryLineChart",
    "CTL_G2IHistoryLineChartTopComponent=G2IHistoryLineChart Window",
    "HINT_G2IHistoryLineChartTopComponent=This is a G2IHistoryLineChart window"
})
public final class G2IHistoryLineChartTopComponent extends TopComponent {

    private JFXPanel m_pFXPanel;
    private G2IHistoryLineChartAssistance m_pG2IHistoryLineChartAssistance = null;

    public G2IHistoryLineChartTopComponent() {
        initComponents();
        setName(Bundle.CTL_G2IHistoryLineChartTopComponent());
        setToolTipText(Bundle.HINT_G2IHistoryLineChartTopComponent());

        Collection<? extends G2IHistoryLineChartAssistance> allHistoryLineChartAssistances = Lookup.getDefault().lookupAll(G2IHistoryLineChartAssistance.class);
        for (G2IHistoryLineChartAssistance gi : allHistoryLineChartAssistances) {
    ...
    private void initComponents() {
        ...
        org.openide.awt.Mnemonics.setLocalizedText(IaCheckBox, org.openide.util.NbBundle.getMessage(G2IHistoryLineChartTopComponent.class, "G2IHistoryLineChartTopComponent.IaCheckBox.text")); // NOI18N
        jPanel3.add(IaCheckBox);

        IbCheckBox.setSelected(true);
        org.openide.awt.Mnemonics.setLocalizedText(IbCheckBox, org.openide.util.NbBundle.getMessage(G2IHistoryLineChartTopComponent.class, "G2IHistoryLineChartTopComponent.IbCheckBox.text")); // NOI18N
        ...
        org.openide.awt.Mnemonics.setLocalizedText(IcCheckBox, org.openide.util.NbBundle.getMessage(G2IHistoryLineChartTopComponent.class, "G2IHistoryLineChartTopComponent.IcCheckBox.text")); // NOI18N
        ...
        org.openide.awt.Mnemonics.setLocalizedText(jLabel1, org.openide.util.NbBundle.getMessage(G2IHistoryLineChartTopComponent.class, "G2IHistoryLineChartTopComponent.jLabel1.text")); // NOI18N
    ...
    private void IbCheckBoxStateChanged(javax.swing.event.ChangeEvent evt) {//GEN-FIRST:event_IbCheckBoxStateChanged
        ...
        Platform.runLater(new Runnable() {
            @Override
            public void run() {
                HistoryLineChartFXMLController controller = m_pG2IHistoryLineChartAssistance.getHistoryLineChartFXMLController();
                if (controller != null) {
    ...
    private void initFXML() {
        ...
        Platform.runLater(new Runnable() {
            @Override
            public void run() {
                StackPane stackPane = m_pG2IHistoryLineChartAssistance.getStackPane();
                Scene scene = new Scene(stackPane);
                m_pFXPanel.setScene(scene);

                HistoryLineChartFXMLController controller = m_pG2IHistoryLineChartAssistance.getHistoryLineChartFXMLController();
                controller.initGraph(stackPane, "Generator 2 current");
            }
        });
    }
}
